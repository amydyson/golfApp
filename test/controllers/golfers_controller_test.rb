...
class GolfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create golfer" do
    assert_difference('Golfer.count') do
      post golfers_url, params: { golfer: { ghin: @golfer.ghin, handicap: @golfer.handicap, name: @golfer.name } }
    end
  ...
  test "should update golfer" do
    patch golfer_url(@golfer), params: { golfer: { ghin: @golfer.ghin, handicap: @golfer.handicap, name: @golfer.name } }
